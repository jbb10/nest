...
<activation critical="MANDATORY">
  ...
  <step n="5b">🌿 BEFORE ANY CODE CHANGES - Create feature branch:
      - git checkout main && git pull origin main
      - git checkout -b {type}/{story_key} (e.g., feat/1-2-user-auth)
      - Branch types: feat/, fix/, chore/, refactor/, test/, docs/
